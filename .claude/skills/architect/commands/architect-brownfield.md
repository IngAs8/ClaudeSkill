...
max 3 questions per message, using `questions/phase-2-branches.md` and
`questions/phase-3-confirmation.md` as the source:
...
Compose from `templates/blueprint-template.md`. **Brownfield gets no sections
...
Emit the canonical bundle (`questions/phase-4-generate.md` Step 3 is the
authority on the tree):

```
./blueprints/<change-slug>/
├── blueprint.md          # the 20-section narrative
├── tasks.json            # templates/tasks-schema.md
├── epics/NN-<name>.md    # templates/epic-template.md
