...
relative to the `architect` skill's own directory — the folder containing its `SKILL.md`. The
only exception is `./blueprints/`, which is always the **user's current working directory**,
